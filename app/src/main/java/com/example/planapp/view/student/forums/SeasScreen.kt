...
import com.example.planapp.ui.theme.Seas_Orange
import com.example.planapp.ui.theme.Seas_Black
import com.example.planapp.ui.theme.Seas_Pal
import com.example.planapp.ui.theme.Seas_Orange
    ...
    OutlinedTextField(
        ...
        trailingIcon = {
            IconButton(onClick = { /*TODO*/ }) {
                Icon(imageVector = Icons.Default.Send, contentDescription = "",tint = Seas_Orange)
            }
        },
        colors = OutlinedTextFieldDefaults.colors(
            unfocusedBorderColor = Color.White,
            focusedBorderColor = Seas_Orange
        )
    )
}
    ...
    Row(modifier = Modifier
            ...
            Alignment.Start))
        {
            Box(modifier = Modifier
                .height(40.dp)
                .width(40.dp)
                .background(Seas_Black, shape = RoundedCornerShape(50.dp)), contentAlignment = Alignment.Center)
            {
            ...
            Row{
                Text(text = "S",color = Seas_Black, style = TextStyle(
                    fontSize = 20.sp,
                    fontFamily = FontFamily(Font(R.font.inika_bold)),
                    fontWeight = FontWeight(700)
                )
                )
                Text(text = "E",color = Seas_Orange, style = TextStyle(
                    fontSize = 20.sp,
                    fontFamily = FontFamily(Font(R.font.inika_bold)),
                    fontWeight = FontWeight(700)
                )
                )
                Text(text = "A",color = Seas_Pal, style = TextStyle(
                    fontSize = 20.sp,
                    fontFamily = FontFamily(Font(R.font.inika_bold)),
                    fontWeight = FontWeight(700)
                )
                )
                Text(text = "S Forum",color = Seas_Black, style = TextStyle(
                    fontSize = 20.sp,
                    fontFamily = FontFamily(Font(R.font.inika_bold)),
                    fontWeight = FontWeight(700)
                )
        ...
        contentAlignment = Alignment.TopStart)
    {
        Row(modifier = Modifier.height(intrinsicSize = IntrinsicSize.Min))
        {
                    ...
                    Box(modifier = Modifier
                        ...
                        Box(
                            modifier = Modifier
                                .height(33.dp)
                                .width(33.dp)
                                .background(Seas_Orange, shape = RoundedCornerShape(50.dp)),
                            contentAlignment = Alignment.Center
                        )
                        {
                            Text(
            ...
            Box(modifier = Modifier.offset(x = (-12).dp)){
                Box(modifier = Modifier
                    .background(Seas_Black, shape = RoundedCornerShape(20.dp))
                    .fillMaxWidth(0.7f)
                    .padding(start = 15.dp, bottom = 15.dp, end = 15.dp))
                {
                    Column {
                        Text("Tec",color = Seas_Pal, fontSize = 17.sp,style = Typography.bodyLarge,modifier = Modifier.padding(vertical = 5.dp))
                        Text(
...
fun RightMessageSeas(){
        ...
        contentAlignment = Alignment.BottomEnd)
    {
        Row(modifier = Modifier.height(intrinsicSize = IntrinsicSize.Min))
        {
            Box(modifier = Modifier.offset(x = (12).dp)){
                Box(modifier = Modifier
                    .background(Seas_Orange, shape = RoundedCornerShape(20.dp))
                    .fillMaxWidth(0.7f)
                    .padding(15.dp))
                {
                    Column {
