...
fun ClassroomSelectScreen(){
    Scaffold(modifier = Modifier
        ...
        topBar = {
            Column{
                TopAppBAr()
                InfoSect("Select They Classroom")
            }
        },
        content = {
            BodySelect()
    ...
    Column{
            ...
            items(10){
                        ...
                        .border(0.5.dp, MainGreen, shape = RoundedCornerShape(29.dp)), contentAlignment = Alignment.Center)
                {
                    Row (verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.SpaceBetween){
                        Text(text = "Amphi 500",style = Typography.bodyLarge, modifier = Modifier.padding(horizontal = 80.dp))
                        Box(
                            modifier = Modifier
                                .border(
                                    0.5.dp,
        ...
        Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Center){
            Button(onClick = { /*TODO*/ },colors = ButtonDefaults.buttonColors(
                ...
                .height(58.dp))
            {
                Text(text = "Finish", style = Typography.bodyLarge, fontSize = 25.sp)
            }
        }
    }
}
