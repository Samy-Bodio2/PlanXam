    ...
    OutlinedTextField(
        ...
        trailingIcon = {
            IconButton(onClick = { /*TODO*/ }) {
                Icon(imageVector = Icons.Default.Send, contentDescription = "",tint = Istdi_Yellow)
            }
        },
    ...
    Row(modifier = Modifier
            ...
            Alignment.Start))
        {
            Box(modifier = Modifier
                .height(40.dp)
                .width(40.dp)
                .background(Istdi_Green, shape = RoundedCornerShape(50.dp)), contentAlignment = Alignment.Center)
            {
            ...
            Row{
                Text(text = "ISTDI Forum",color = Istdi_Yellow, style = TextStyle(
                    fontSize = 20.sp,
                    fontFamily = FontFamily(Font(R.font.inika_bold)),
                    fontWeight = FontWeight(700)
                )
        ...
        contentAlignment = Alignment.TopStart)
    {
        Row(modifier = Modifier.height(intrinsicSize = IntrinsicSize.Min))
        {
                    ...
                    Box(modifier = Modifier
                        ...
                        Box(
                            modifier = Modifier
                                .height(33.dp)
                                .width(33.dp)
                                .background(Istdi_Yellow, shape = RoundedCornerShape(50.dp)),
                            contentAlignment = Alignment.Center
                        )
                        {
                            Text(
            ...
            Box(modifier = Modifier.offset(x = (-12).dp)){
                Box(modifier = Modifier
                    .background(Istdi_Green, shape = RoundedCornerShape(20.dp))
                    .fillMaxWidth(0.7f)
                    .padding(start = 15.dp, bottom = 15.dp, end = 15.dp))
                {
                    Column {
                        Text("Tec",color = Istdi_Yellow, fontSize = 17.sp,style = Typography.bodyLarge,modifier = Modifier.padding(vertical = 5.dp))
                        Text(
...
fun RightMessageIstdi(){
        ...
        contentAlignment = Alignment.BottomEnd)
    {
        Row(modifier = Modifier.height(intrinsicSize = IntrinsicSize.Min))
        {
            Box(modifier = Modifier.offset(x = (12).dp)){
                Box(modifier = Modifier
                    .background(Istdi_Yellow, shape = RoundedCornerShape(20.dp))
                    .fillMaxWidth(0.7f)
                    .padding(15.dp))
                {
                    Column {
